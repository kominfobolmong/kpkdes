        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="{{ route('realisasi_anggaran.update', $item->id) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        @include('pages.realisasi_anggaran.partials.form-control', ['submit' => 'Update'])
                    </form>
                </div>
            </div>
        </div>
