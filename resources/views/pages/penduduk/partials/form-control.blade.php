<div class="card-body">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="rw" name="rw" placeholder="No KK" value="{{ old('rw') ?? $item->rw }}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="nama_ibu_kandung" name="nama_ibu_kandung" placeholder="nama_ibu_kandung" value="{{ old('nama_ibu_kandung') ?? $item->nama_ibu_kandung }}">
    </div>
